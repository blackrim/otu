...
public enum SearchableProperty {
	...
	OT_FOCAL_CLADE("focal clade", NodeProperty.OT_FOCAL_CLADE, NodeIndexDescription.SOURCE_METADATA_NODES_BY_OT_PROPERTY),
...
//    DESCENDANT_MAPPED_TAXON_NAMES_WHITESPACE_FILLED(NodeProperty.DESCENDANT_MAPPED_TAXON_NAMES_WHITESPACE_FILLED, NodeIndexDescription.TREE_ROOT_NODES_BY_MAPPED_TAXON_NAME_WHITESPACE_FILLED),
    DESCENDANT_MAPPED_TAXON_OTT_IDS("ott id", NodeProperty.OT_OTT_ID, NodeIndexDescription.TREE_ROOT_NODES_BY_MAPPED_TAXON_OTT_ID);
